    ...
    <div class="bg-white shadow-lg rounded-lg w-full max-w-4xl flex overflow-hidden">
        ...
        <div class="w-full lg:w-1/2 p-8">
            ...
            <form method="POST" action="{{ url('/login-post') }}">
                ...
                <div class="mb-4">
                    <label for="email"
                        class="block text-sm font-medium text-gray-600 mb-2">{{ __('Correo') }}</label>
                ...
                <div class="mb-6">
                    <label for="password"
                        class="block text-sm font-medium text-gray-600 mb-2">{{ __('Contraseña') }}</label>
                ...
                <div class="mb-6">
                    <button type="submit"
                        class="w-full bg-[#274275] text-white py-2 px-4 rounded-lg hover:bg-[#274275] transition duration-300 cursor-pointer">{{ __('Iniciar Sesión') }}</button>
                </div>
                ...
                <div class="text-center">
                    <p class="text-lg font-bold text-gray-900 mb-4"><a href="{{ url('/caseta') }}">{{ __('Caseta') }}</a></p>
                </div>
            </form>
        </div>
    </div>
